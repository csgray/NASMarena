...
section .data   ; initialized variables 
    ...
    invOut db "Invalid input.",0xa
    invOutLen equ $ - invOut
...
compare:
    ...
    ; Invalid output (none of the above)
    mov rax, 1          ; system call number (sys_write)
    mov rdi, 1          ; file descriptor (standard output)
    mov rsi, invOut     ; output string
    mov rdx, invOutLen  ; length of string
    syscall
